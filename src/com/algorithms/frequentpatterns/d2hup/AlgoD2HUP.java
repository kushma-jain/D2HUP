...
import com.algorithms.ItemNameConverter;
...
//		
	...
	public String printStats() {
            ...
            String data = "";
		data+="=============  D2HUP ALGORITHM v97- STATS =============\n";
		data+=" Case1 count: " + case1count + " | Case2 count: " + case2count+"\n";
		data+=" Total time ~ " + (endTimestamp - startTimestamp) + " ms"+"\n";
		data+=" Max Memory ~ " + MemoryLogger.getInstance().getMaxMemory() + " MB"+"\n";
		data+=" High-utility itemsets count : " + huiCount+"\n"; 
		data+="===================================================";
